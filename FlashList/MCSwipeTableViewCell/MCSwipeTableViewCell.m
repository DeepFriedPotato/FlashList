...
- (id)mutableCopyWithZone:(NSZone *)zone{
    MCSwipeTableViewCell *newCell = [[MCSwipeTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    newCell.delegate = self.delegate;
    newCell.damping = self.damping;
    newCell.velocity = self.velocity;
    newCell.animationDuration = self.animationDuration;
    newCell.defaultColor = self.defaultColor;
    newCell.color1 = self.color1;
    newCell.color2 = self.color2;
    newCell.color3 = self.color3;
    newCell.color4 = self.color4;
    newCell.view1 = self.view1;
    newCell.view2 = self.view2;
    newCell.view3 = self.view3;
    newCell.view4 = self.view4;
    newCell.completionBlock1 = self.completionBlock1;
    newCell.completionBlock2 = self.completionBlock2;
    newCell.completionBlock3 = self.completionBlock3;
    newCell.completionBlock4 = self.completionBlock4;
    newCell.firstTrigger = self.firstTrigger;
    newCell.secondTrigger = self.secondTrigger;
    newCell.modeForState1 = self.modeForState1;
    newCell.modeForState2 = self.modeForState2;
    newCell.modeForState3 = self.modeForState3;
    newCell.modeForState4 = self.modeForState4;
    newCell.shouldDrag = self.shouldDrag;
    newCell.shouldAnimateIcons = self.shouldAnimateIcons;
